...
rsconnect::setAccountInfo(name='joshuagsmith',
                          token='XXXXXXXXXXXXX',
                          secret='XXXXXXXXXXXXX') 


rsconnect::deployApp("/home/joshsmith/CA_MPA_Project/ca-mpa/data/monitoring_data/monitoring_site_table/site_app")
