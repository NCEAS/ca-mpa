...
text(-8, c(48,36,23,12), pos=4, c("North",
                                 "Central",
                                 "N. Channel Islands",
                                 "South"))
...
addpoly(res.c.target, row= 26,cex=0.75, mlab=mlabfun("RE Model for targeted", y=res.c.target), col='red'
        )
text(-8, 26, pos=4, cex=0.7, mlabfun("RE Model for targeted", y=res.c.target))

addpoly(res.c.nontarget, row= 25,cex=0.75, mlab=mlabfun("RE Model for nontargeted", y=res.c.nontarget), col='blue'
        )
text(-8, 25, pos=4, cex=0.7, mlabfun("RE Model for nontargeted", y=res.c.nontarget))
...
addpoly(res.s.target, row= 2,cex=0.75, mlab=mlabfun("RE Model for targeted", y=res.s.target), col='red'
        )
text(-8, 2, pos=4, cex=0.7, mlabfun("RE Model for targeted", y=res.s.target))

addpoly(res.s.nontarget, row= 1,cex=0.75, mlab=mlabfun("RE Model for nontargeted", y=res.s.nontarget), col='blue'
        )
text(-8, 1, pos=4, cex=0.7, mlabfun("RE Model for nontargeted", y=res.s.nontarget))



### fit meta-regression model to test for subgroup differences
res <- rma(yi, vi, mods = ~ region4+target_status+mean_age_smr, data=dat)
...
addpoly(res.target, row= -2,cex=0.75, mlab=mlabfun("RE Model for Subgroup", y=res.target), col='red')
text(-8, -2, pos=4, cex=0.7, mlabfun("targeted biomass", y=res.target))

addpoly(res.nontarget, row= -3,cex=0.75, mlab=mlabfun("RE Model for Subgroup", y=res.nontarget), col='blue')
text(-8, -3, pos=4, cex=0.7, mlabfun("nontargeted biomass", y=res.nontarget))

addpoly(res.overall, row=-1, cex=0.75, mlab=mlabfun("RE Model for Subgroup", y=res.overall), col='black' )
text(-8, -1, pos=4, cex=0.7, mlabfun("biomass overall", y=res.overall))
...
text(x =-0.2, y = 52, "REF",  pos=2, font=2)
text(x =1.3, y = 52, "SMR",  pos=2, font=2)
text(x =-3, y = 53.5, "targeted and nontargeted fish biomass 2016-20",  cex=1, pos=2, font=3)
...
#test moderators
(res.target.mods <- rma(yi, vi, mods = ~ mean_age_smr+mean_size_smr, data=dat_target))
()
