...
CCFRP.resampled_RR_CI <- cbind(resampled_1, CI_5, CI_95, year, n_mpa, n_ref, region) 
...
CCFRP.resampled_RR_CI$year <- as.numeric(CCFRP.resampled_RR_CI$year)

ggplot(CCFRP.resampled_RR_CI, aes(x=year, y=logRR))+
...
# Combine true means, null confidence intervals and year into one data frame
KF_SWATH.resampled_RR_CI <- cbind(resampled_1, CI_5, CI_95, year, n_mpa, n_ref, region) 
...
KF_SWATH.resampled_RR_CI$year <- as.numeric(KF_SWATH.resampled_RR_CI$year)

ggplot(KF_SWATH.resampled_RR_CI, aes(x=year, y=logRR))+
  geom_hline(yintercept=0, linetype="dashed", color = "gray", size = 0.5) +
  geom_ribbon(aes(ymax=eCI_95, ymin=eCI_5), group=1, alpha=0.2, fill = "#BC1605") +
  geom_point(shape=19, size=3, color = "#BC1605") +
  geom_smooth(method='lm', se = T, formula=y~x, linetype='solid', size=0.5) +
...
# Combine true means, null confidence intervals and year into one data frame
KF_UPC.resampled_RR_CI <- cbind(resampled_1, CI_5, CI_95, year, n_mpa, n_ref, region) 
...
KF_UPC.resampled_RR_CI$year <- as.numeric(KF_UPC.resampled_RR_CI$year)

ggplot(KF_UPC.resampled_RR_CI, aes(x=year, y=logRR))+
  geom_hline(yintercept=0, linetype="dashed", color = "gray", size = 0.5) +
  geom_ribbon(aes(ymax=eCI_95, ymin=eCI_5), group=1, alpha=0.2, fill = "#BC1605") +
  geom_point(shape=19, size=3, color = "#BC1605") +
  geom_smooth(method='lm', se = T, formula=y~x, linetype='solid', size=0.5) +
...
# Combine true means, null confidence intervals and year into one data frame
KF_fish.resampled_RR_CI <- cbind(resampled_1, CI_5, CI_95, year, n_mpa, n_ref, region) 
...
KF_fish.resampled_RR_CI$year <- as.numeric(KF_fish.resampled_RR_CI$year)

ggplot(KF_fish.resampled_RR_CI, aes(x=year, y=logRR))+
  geom_hline(yintercept=0, linetype="dashed", color = "gray", size = 0.5) +
  geom_ribbon(aes(ymax=eCI_95, ymin=eCI_5), group=1, alpha=0.2, fill = "#BC1605") +
  geom_point(shape=19, size=3, color = "#BC1605") +
  geom_smooth(method='lm', se = T, formula=y~x, linetype='solid', size=0.5) +
...
deep_reef <- deep_reef[!is.infinite(deep_reef$logRR),]
...
# Combine true means, null confidence intervals and year into one data frame
deep_reef.resampled_RR_CI <- cbind(resampled_1, CI_5, CI_95, year, n_mpa, n_ref, region) 
...
deep_reef.resampled_RR_CI$year <- as.numeric(deep_reef.resampled_RR_CI$year)

ggplot(deep_reef.resampled_RR_CI, aes(x=year, y=logRR))+
  geom_hline(yintercept=0, linetype="dashed", color = "gray", size = 0.5) +
  geom_ribbon(aes(ymax=eCI_95, ymin=eCI_5), group=1, alpha=0.2, fill = "#BC1605") +
  geom_point(shape=19, size=3, color = "#BC1605") +
  geom_smooth(method='lm', se = T, formula=y~x, linetype='solid', size=0.5) +
...
ggplot(resampled, aes(x=year, y=logRR))+
  geom_hline(yintercept=0, linetype="dashed", color = "gray", size = 0.5) +
  geom_ribbon(aes(ymax=eCI_95, ymin=eCI_5), group=1, alpha=0.2, fill = "#BC1605") +
  geom_point(shape=19, size=3, color = "#BC1605") +
  geom_smooth(method='lm', se = T, formula=y~x, linetype='solid', size=0.5) +
  ...
  scale_x_continuous(breaks = seq(from=2007, to=2021, by=2))+
  theme_classic() 
