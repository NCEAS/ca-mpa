...
```{r}
mds <- metaMDS(data[2:23], distance = "euclidean")
mds
stressplot(mds)
plot(mds)
```
...
```{r}
mds_noest <- metaMDS(data_noest[2:23], distance = "euclidean")
mds_noest
