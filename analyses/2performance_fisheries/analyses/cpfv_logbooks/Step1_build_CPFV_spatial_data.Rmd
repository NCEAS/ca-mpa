...
g2 <- ggplot() +
  ...
  geom_sf(data=usa, fill="grey80", color="white", lwd=0.3) +
  # Plot points
  geom_point(data=data_xy1, mapping=aes(x=block_long_dd, y=block_lat_dd, color=reliable_yn), pch=21, size=0.8, alpha=0.5) +
  # Labels
  labs(x="", y="", tag="B") +
...
g3 <- ggplot() +
  ...
  geom_sf(data=usa, fill="grey80", color="white", lwd=0.3) +
  # Plot points
  geom_point(data=data_xy1 %>% filter(reliable_yn=="yes"), mapping=aes(x=block_long_dd, y=block_lat_dd), 
