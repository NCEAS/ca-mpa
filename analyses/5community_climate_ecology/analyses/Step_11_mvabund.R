...
################################################################################
#mvabund explore  --- community responses by heatwave period (before vs after only)
#CENTRAL COAST ONLY
#testing mvabund without using block = year 
...
#fit glms. Default family = negative binomial. 
CCFRP_glm <- manyglm(CCFRP_spp ~ CCFRP_join$MHW, family = "poisson",
