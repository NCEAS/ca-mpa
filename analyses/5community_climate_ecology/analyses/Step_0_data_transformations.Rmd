...
rocky_ord <- metaMDS(rocky_distmat, distance="bray",k=2, trymax = 300, parallel = num_cores)
...
#data_path <- "/home/shares/ca-mpa/data/sync-data/monitoring/processed_data/ecological_community_data/year_level_with_envr_vars"
#save(CCFRP_en, kelp_invalg_en, kelp_fish_en, deep_reef_en, rocky_ord, file = file.path(data_path, "env_fit_scores.rda"))
