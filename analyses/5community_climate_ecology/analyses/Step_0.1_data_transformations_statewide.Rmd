...
kelp_invalg_mat_data <- kelp_invalg2%>%
              ungroup()%>%
...
kelp_invalg_distmat <- 
    vegdist(kelp_invalg_mat_data, method = "bray", na.rm=T) #generates a BC dissim matrix
...
#save(kelp_invalg_group_vars,kelp_fish_group_vars,
#  rocky_group_vars,
#    file = file.path(output_path, "group_vars_statewide.rda"))

#save community matrices
#save(kelp_invalg_ord_data,kelp_fish_ord_data,
#  rocky_ord_data,
...
#save(kelp_invalg_distmat,kelp_fish_distmat,
#     rocky_distmat,
