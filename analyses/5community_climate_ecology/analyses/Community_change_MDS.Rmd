...
CCFRP_distmat <- vegdist(CCFRP_rel, method = "bray") 
...
```{R}
CCFRP_ord <- metaMDS(CCFRP_distmat, distance="bray") #ordinates the dist matrix
kelp_swath_ord <- metaMDS(kelp_swath_distmat, distance="bray") #ordinates the dist matrix
kelp_fish_ord <- metaMDS(kelp_fish_distmat, distance="bray")
kelp_upc_ord <- metaMDS(kelp_upc_distmat, distance="bray")
deep_reef_ord <- metaMDS(deep_reef_distmat, distance="bray")
rocky_ord <- metaMDS(rocky_distmat, distance="bray")


#export to .RData
path_aurora <- "/home/shares/ca-mpa/data/sync-data/processed_data/ecological_community_data" 
save(CCFRP_ord, kelp_swath_ord, kelp_fish_ord, kelp_upc_ord, deep_reef_ord, rocky_ord, file = file.path(path_aurora, "bray_nmds_scores.rda"))
