...
#data_path <- "/home/shares/ca-mpa/data/sync-data/monitoring/processed_data/ecological_community_data/year_level_with_envr_vars"
#save(CCFRP_ord_data,kelp_swath_ord_data,kelp_upc_ord_data,kelp_fish_ord_data,
...
#data_path <- "/home/shares/ca-mpa/data/sync-data/monitoring/processed_data/ecological_community_data/year_level_with_envr_vars"
#save(CCFRP_en, kelp_swath_en, kelp_fish_en, kelp_upc_en, deep_reef_en, rocky_ord, file = file.path(data_path, "env_fit_scores.rda"))
...
en_coord_cont = as.data.frame(scores(kelp_swath_en, "vectors")) * ordiArrowMul(kelp_swath_en, fill=0.3)
