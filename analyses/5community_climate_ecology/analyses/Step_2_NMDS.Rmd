...
en_coord_cont = as.data.frame(scores(CCFRP_en, "vectors")) * ordiArrowMul(CCFRP_en, fill=0.15)
...
en_coord_cont = as.data.frame(scores(rocky_en, "vectors")) * ordiArrowMul(rocky_en, fill=0.1)
...
#cowplot::save_plot(here::here("analyses", "5community_climate_ecology", "figures", "community_structure_central2.png"), figure, bg="white",dpi = 600, units = "in")
...
figure<-ggarrange(CCFRP_trajectory, kelp_fish_trajectory, deep_reef_trajectory,
          kelp_invalg_trajectory, rocky_trajectory, common.legend = TRUE, legend="right",
