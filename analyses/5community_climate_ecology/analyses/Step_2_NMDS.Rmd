  ...
  geom_path(data = df_ell, aes(NMDS1, NMDS2, colour=MHW, 
   ...
   geom_segment(aes(x = 0, y = 0, xend = (NMDS1), yend = (NMDS2)), 
     ...
     geom_text(data = en_coord_cont, aes(x = (NMDS1), y = (NMDS2)), colour = "black", 
       fontface = "bold", label = row.names(en_coord_cont), position=position_jitter(width=0.04,height=0.04), size=2) + 
...
cowplot::save_plot(here::here("analyses", "5community_climate_ecology", "figures", "community_structure_central4.png"), cplot, bg="white",dpi = 600, units = "in", base_width=8.5, base_height = 6)
