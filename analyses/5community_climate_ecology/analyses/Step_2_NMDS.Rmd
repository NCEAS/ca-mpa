  ...
  geom_path(data = df_ell, aes(NMDS1, NMDS2, colour=MHW, 
   ...
   geom_segment(aes(x = 0, y = 0, xend = (NMDS1), yend = (NMDS2)), 
     ...
     geom_text(data = en_coord_cont, aes(x = (NMDS1), y = (NMDS2)), colour = "black", 
       fontface = "bold", label = row.names(en_coord_cont), position=position_jitter(width=0.01,height=0.01), size=2.8) + 
...
en_coord_cont = as.data.frame(vegan::scores(kelp_invalg_en, "vectors")) * ordiArrowMul(kelp_invalg_en, fill=0.15)
...
kelp_invalg<- ggplot(data=cent, aes(NMDS1, NMDS2)) +
  ...
  geom_path(data = df_ell, aes(NMDS1, NMDS2, colour=MHW, 
   ...
   geom_segment(aes(x = 0, y = 0, xend = (NMDS1), yend = (NMDS2)), 
       ...
       arrow = arrow(length = unit(0.25, "cm")), colour = "grey50", lwd=0.5)+
     geom_text(data = en_coord_cont, aes(x = (NMDS1), y = (NMDS2)), colour = "black", 
       fontface = "bold", label = row.names(en_coord_cont), position=position_jitter(width=0.02,height=0.02), size=2.8) + 
...
deep_reef<- ggplot(data=cent, aes(NMDS1, NMDS2)) +
  ...
  geom_path(data = df_ell, aes(NMDS1, NMDS2, colour=MHW, 
   ...
   geom_segment(aes(x = 0, y = 0, xend = (NMDS1), yend = (NMDS2)), 
       ...
       arrow = arrow(length = unit(0.25, "cm")), colour = "grey50", lwd=0.5)+
     geom_text(data = en_coord_cont, aes(x = (NMDS1), y = (NMDS2)), colour = "black", 
       fontface = "bold", label = row.names(en_coord_cont), position=position_jitter(width=0.01,height=0.02), size=2.8) + 
...
cowplot::save_plot(here::here("analyses", "5community_climate_ecology", "figures", "community_structure_central5.png"), cplot, bg="white",dpi = 600, units = "in", base_width=8.5, base_height = 6)
...
cowplot::save_plot(here::here("analyses", "5community_climate_ecology", "figures", "community_trajectory.png"), cplot, bg="white",dpi = 600, units = "in", base_width=10, base_height = 8)
