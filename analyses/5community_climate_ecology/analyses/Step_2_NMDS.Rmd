...
cent$mpa_designation <- recode_factor(cent$mpa_designation, "smr"="Inside MPA")
cent$mpa_designation <- recode_factor(cent$mpa_designation, "ref"="Outside MPA")
...
CCFRP<- ggplot(data=cent, aes(NMDS1, NMDS2)) +
  geom_point(aes(shape=mpa_designation, color=MHW), size=3) +                           #centroids
  geom_path(data = df_ell, aes(NMDS1, NMDS2, colour=MHW, 
                               group=group), size = 0.4, linetype=2, 
  ...
  labs(shape="MPA type",color='Heatwave period') +
  annotate(geom="text", 
           x=0.12, 
           y=0.2, 
           col="black", 
