...
tmap_save(tm_ncis_rr, filename = "../figs/mpa_RR_ncis.png")
```
...
tm_shape(st_perform_metrics_all[!is.na(st_perform_metrics_all$RR),] %>% filter(mlpa_region %in% c("island", "south"))) + 
  tm_symbols(col = "RR",  alpha = 0.8, border.lwd = 0, size = .5, title.col = "North Region Log Ratios", palette = "Spectral", style = "quantile") + 
