...
#cohens_d  = abs(mean_diff)/(sqrt((sd_MPA^2*(n_MPA-1)+sd_REF^2*(n_REF-1) )/df)
dat <- metafor::escalc(measure="SMD", m1i=mean_MPA, m2i=mean_REF, sd1i=sd_MPA, sd2i=sd_REF, n1i=n_MPA, n2i=n_REF, data=means_format, slab=paste(group)) 
